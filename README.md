...
finetune and native note quantization, pitch slides, tone portamento with glissando, vibrato and tremolo with waveform controls and mono8 sample-offset/retrigger/note-delay subsets. Full classic-effect compatibility remains in
