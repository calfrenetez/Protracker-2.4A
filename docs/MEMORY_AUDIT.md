...
| Project/sample import | Whole-file payload uses master allocator,64MiB input ceiling; decoding staged transactionally | FILE object/read-ahead still uses runtime allocation |
...
Next actionable gaps are bounded import I/O and recent-file workspace ownership.
