 ...
 * Only 000, 1xx, 2xx, 3xx, 5xx, A/B/C/D, E1/E2/E6/EA/EB/EC/EE and F are supported by
 * the renderer. Call once after each completed flow tick, including delays. */
struct pt_pitch_channel {uint16_t period,output,target;uint8_t instrument,sounding,empty,speed,up,unsupported;};
