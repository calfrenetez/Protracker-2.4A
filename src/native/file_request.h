...
#include <stddef.h>
struct Window;
/* saving: 0 load, 1 new project, 2 new classic MOD, 3 load WAV/IFF, 4 new WAV, 5 new IFF, 6 RAW load, 7 new RAW, 8 MOD sample source, 9 new rendered WAV, 10 new stem directory.
