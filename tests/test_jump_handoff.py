...
from make_handoff_fixtures import jump_fixtures
from test_instrument_emulator import decode_trace
class JumpHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev81/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in jump_fixtures():
