...
class ModRound8(unittest.TestCase):
    def test_core_and_explicit_new_file_policy(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            subprocess.run([*flags,'tools/pt24g_convert.c','src/platform/mod_import.c','src/platform/project_import.c','src/platform/pp20_import.c', 'src/platform/project_file.c', 'src/platform/mod_file.c', 'src/platform/file_save.c',*SOURCES,'-o',str(cli)],cwd=ROOT,check=True)
