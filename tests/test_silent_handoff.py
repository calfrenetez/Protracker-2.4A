...
from make_handoff_fixtures import silent_tail_fixtures
from test_instrument_emulator import decode_trace
class SilentHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev72/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in silent_tail_fixtures():
