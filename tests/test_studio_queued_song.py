    ...
    def test_song_lifecycle(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            subprocess.run(['cc','-std=c99','-O1','-g','-Wall','-Wextra','-Werror','-fsanitize=address,undefined','-Isrc/core',
                            'tests/studio_queued_song_test.c','src/core/studio_queue.c','src/core/studio_pump.c','src/core/studio_song.c','src/core/studio_plan.c','src/core/studio_mix.c','src/core/render.c','src/core/pitch.c','src/core/timeline.c','src/core/frame_clock.c','src/core/flow.c',
