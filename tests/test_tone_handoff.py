...
from make_handoff_fixtures import tone_fixtures
from test_instrument_emulator import decode_trace
class ToneHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev75/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in tone_fixtures():
