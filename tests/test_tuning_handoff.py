...
from make_handoff_fixtures import tuning_fixtures
from test_instrument_emulator import decode_trace
class TuningHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev78/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in tuning_fixtures():
