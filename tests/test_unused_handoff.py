...
from make_handoff_fixtures import unused_handoff_fixtures
from test_instrument_emulator import decode_trace
class UnusedHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev86/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in unused_handoff_fixtures():
                ...
                for offset in range(0,len(trace),140):
                    ...
                    if row==1:self.assertEqual(int.from_bytes(r[44:46],'big'),428 if meta['effect']==8 else 441)
