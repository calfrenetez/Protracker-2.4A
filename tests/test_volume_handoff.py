...
from make_handoff_fixtures import volume_fixtures
from test_instrument_emulator import decode_trace
class VolumeHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev69/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in volume_fixtures():
                ...
                for offset in range(0,len(trace),140):
                    ...
                    self.assertEqual(r[32],64 if row==0 else meta['volume'])
