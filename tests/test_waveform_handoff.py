...
from make_handoff_fixtures import waveform_fixtures
from test_instrument_emulator import decode_trace
class WaveformHandoff(unittest.TestCase):
    def test_pinned_volume_and_pcm(self):
        evidence=ROOT/'evidence/enhanced-editor/dev77/native-reference'
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name,data,meta in waveform_fixtures():
