...
def main():
    ...
    commands=[('disk',400,70),('back',400,80),('play',250,10),('stop',400,10),('audition',250,87),('bottom-stop',510,502)]
    ...
    try:
        ...
        (out/'native-mouse.json').write_text(json.dumps(report,indent=2)+'\n');print('PASS: input.device mouse events consumed by Disk Op, Back, Play, Stop, Sample and bottom Stop; DMA off and normal exit')
    finally:
