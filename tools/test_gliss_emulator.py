#!/usr/bin/env python3
"""Verify tone-portamento rendering against repeated pinned native traces. Reserve Amiberry first."""
import hashlib
import json
...
from make_gliss_fixtures import fixtures
...
def main(factory=fixtures,suite="gliss",scope=None):
