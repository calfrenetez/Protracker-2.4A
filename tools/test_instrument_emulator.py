...
def main():
    ...
    if '--nonloop-effects' in sys.argv:
        from make_handoff_fixtures import nonloop_effect_fixtures as source
    ...
    if '--offset-handoff' in sys.argv:
        from make_handoff_fixtures import offset_handoff_fixtures as source
    if '--delayed-handoff' in sys.argv:
        from make_handoff_fixtures import delayed_handoff_fixtures as source
    if '--repeat-track-handoff' in sys.argv:
        from make_handoff_fixtures import repeat_track_fixtures as source
    ...
    if '--tuning-handoff' in sys.argv:
        from make_handoff_fixtures import tuning_fixtures as source
    if '--waveform-handoff' in sys.argv:
        from make_handoff_fixtures import waveform_fixtures as source
